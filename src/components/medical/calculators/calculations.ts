...
import { Gender, ActivityLevel, SteroidConversion, WarfarinRecommendation } from './types';

// Re-export types for convenience
export type { Gender, ActivityLevel, SteroidConversion, WarfarinRecommendation } from './types';

// Define local steroid conversion type for this file
export interface SteroidConversionInfo {
  name: string;
...
export const steroidConversions: Record<string, SteroidConversionInfo> = {
...
export interface SteroidConversionResult {
  equivalentDose: number;
  fromInfo: SteroidConversionInfo;
  toInfo: SteroidConversionInfo;
